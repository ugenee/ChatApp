...
var generateQueryHook = async ({
  ...
  const hasQueryV5WithInfiniteQueryOptionsError = query.version === 5 || isQueryV5WithInfiniteQueryOptionsError(
    context.output.packageJson,
    outputClient
  );
  ...
  let implementation = "";
  let mutators = void 0;
  let isQuery = import_core3.Verbs.GET === verb && (override.query.useQuery || override.query.useSuspenseQuery || override.query.useInfinite || override.query.useSuspenseInfiniteQuery || (operationQueryOptions == null ? void 0 : operationQueryOptions.useQuery) || (operationQueryOptions == null ? void 0 : operationQueryOptions.useSuspenseQuery) || (operationQueryOptions == null ? void 0 : operationQueryOptions.useInfinite) || (operationQueryOptions == null ? void 0 : operationQueryOptions.useSuspenseInfiniteQuery));
